...
window.onload=function(){
    ...
    for(let r=0; r<rows; r++){
        for(let c=0; c<columns; c++){
            ...
            elemento.addEventListener("dragstart", dragStart); //haga click en la imagen para arrastrar
            ...
            elemento.addEventListener("dragend", dragEnd);//despues de completar un arrastre
    ...
    //*arrastrar elementos
    function dragStart(){
        actual = this; //imagen en la que se hizo clic para arrstrar
    }
    function dragOver(e){
        e.preventDefault();
    }
